...
Today's lab is review of [manipulating data](https://datacarpentry.org/R-ecology-lesson/04-visualization-ggplot2.html) and a walk through of [ggplot](https://datacarpentry.org/R-ecology-lesson/04-visualization-ggplot2.html) using Data Carpentry's tutorials. Next week we will return to working with the SNP data.
