...
The graduate students at UMass created and lead a Bioinformatics User Group (BUG) that offers weekly programming sessions, tutorials, a Slack Channel and other helpful information. If you are interested in learning more join the Slack Channel (Bioinformatics User Group (BUG) https://join.slack.com/t/umass-bioinformatics/shared_invite/zt-1fik4ylqe-zPnYpxU4VOKdZpF1m5oeXA
...
If you are a graduate student in 597 please set up an account (you will need your PIs approval) on Unity https://unity.rc.umass.edu/. You will be using R and RStudio from the Unity HPC. You are also welcome to use R and RStudio it from your own computer.
...
* If you are working on RStudio Cloud or the Unity You will need to first export the your Lab1_yourname.html file to yourcomputer.
