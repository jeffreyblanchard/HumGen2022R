---
title: "Human Genome Analysis Lab 8 : Analysis of SNP data using SNPedia and Promethease"
output:
  html_document:
    toc: true
    toc_depth: 4
...
There are Promethease results from Person A and Person B on the Moodle site. Download the zip files and place in separate folders (e.g. Promethease A and B). They unzip/decompress. If you have Windows you may need to download a software package to unzip the file - https://www.wikihow.com/Open-a-.Zip-File-Without-Winzip

Discuss the concepts of Magnitude and Repute. Do you agree with using these concepts in a genetic testing report? How might you change or create a different system to highlight particular results. Write a report to a person who just recieved their Promethease report explaining their results (include good, not set and bad, 3 medical conditions), how they were determined, and how they might act on this information. Include not only medical related SNPs, but some of the popular ones list on the SNPedia page. You can substitute the data set you will use in the final report, but please do not include names of the person who kit is used in your report. There is no code to upload for this lab, but write the report in rMarkdown and knit to produce the html file to upload onto Moodle.
