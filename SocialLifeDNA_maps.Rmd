---
title: "Maps from the COVID-19 reporting data"
output:
  html_document:
    toc: true
    toc_depth : 4
...
### Today's libaries (you will likely need to install all of these, except tidyverse and lubridate)
...
* Update the graphs with the confirmed cases "Number of Confirmed Cases by US County" to 10/15/2022  (change the date in the URL).
* Graph a different state than Massachusetts.
